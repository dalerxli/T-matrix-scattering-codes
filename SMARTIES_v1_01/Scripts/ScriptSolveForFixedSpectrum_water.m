...
% We define parameters for an oblate 
% spheroid
% 
% 
a = 100; c = 40 % in nm
lambda = logspace(-1,2,10)'*1e3; % in nm
epsilon2 = 1.33^2*lambda.^0; % particle
epsilon1 = 1.0; % embedding medium
