...
c     .........................................................................
  ...
  101 FORMAT(I4/(F8.4))
  102 FORMAT(I4)
  103 FORMAT(1X,'Volume and sphere radius:',2F10.4)
  104 FORMAT(1X,'2*A, 2*B, GEOM/PI R^2:',3F10.4)
...
c     .........................................................................
  ...
  300       READ (5,101) NC,ARV0,DRV
            ...
            VOLUME = 4./3.*3.1415*ARV0**3
            ARVAL = (3./4/3.1415*VOLUME)**(1./3)
            WRITE(9,103) VOLUME, ARVAL
       GO TO 304
...
C     Oblate reporting (SPN)
      IF (K.EQ.1) THEN
        BVAL = (VOLUME*3/(4*PI*AB**2))**(1./3)
        AVAL = AB*BVAL
        GEOMETRICAL_AREA = PI*AVAL**2
        GOVEREQUIV = GEOMETRICAL_AREA/(PI*ARVAL**2)
        WRITE(9,104), 2*AVAL, 2*BVAL, GOVEREQUIV
      ENDIF
...
15        CONTINUE
        ...
        INDXR(I)=IROW
        INDXC(I)=ICOL
        IF (cdabs(A(ICOL,ICOL)).EQ.(0.0d0,0.0d0)) THEN
C                PAUSE 'Singular matrix'
                WRITE(6,*) 'Singular matrix'
                STOP
        ENDIF
